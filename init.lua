...
vim.opt.guifont = { "JetBrains Mono", "10" }
...
-- Testing
-- vim.keymap.set("n", "<leader>tr", require("neotest").run.run(), { desc = "Run Nearest Test" })
-- vim.keymap.set("n", "<leader>tf", require("neotest").run.run_file, { desc = "Run File Tests" })
